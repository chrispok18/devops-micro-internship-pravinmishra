...
![Output of `sudo systemctl status nginx --no-pager` showing Active (running))](screenshots/assignment-04-screenshot-01.png)
...
![Output of `ls -la` showing the extracted project folder)](screenshots/assignment-04-screenshot-02.png)
...
![Nano editor open with the updated footer showing your Full Name, Group, Week, and Date)](screenshots/assignment-04-screenshot-03.png)
...
![Output of `sudo nginx -t` showing configuration test successful)](screenshots/assignment-04-screenshot-04.png)
...
![Output of `ls /var/www/html` showing deployed website files)](screenshots/assignment-04-screenshot-05.png)
...
![Output of `curl ifconfig.me` showing the server's public IP address)](screenshots/assignment-04-screenshot-06.png)

---

#### Screenshot 6 — Browser showing the live website with your Full Name and deployment details in the footer

![Browser showing the live website with your Full Name and deployment details in the footer)](screenshots/assignment-04-screenshot-07.png)
...
![Output of `systemctl is-enabled nginx`)](screenshots/assignment-04-screenshot-08.png)

---

#### Screenshot 8 — Output of `curl -I http://localhost` showing 200 OK

![Output of `curl -I http://localhost` showing 200 OK)](screenshots/assignment-04-screenshot-08.png)
...
`https://www.linkedin.com/posts/caryee_devops-nginx-aws-share-7483888483275640833--6hv/?utm_source=share&utm_medium=member_desktop&rcm=ACoAACP6ElcBF7-kOglrea_3V5oUhVp4NSh-Trc`

---

#### Screenshot — Published LinkedIn post showing the live website with your Full Name in the footer

![Output of `curl -I http://localhost` showing 200 OK)](screenshots/assignment-04-screenshot-09.png)
