...
![Output of `node -v && npm -v` showing installed versions](screenshots/assignment-02-screenshot-01.png)
...
![Output of `systemctl status nginx --no-pager` showing Active (running)](screenshots/assignment-02-screenshot-02.png)
...
![Output of `ls` inside the `my-react-app` directory showing project files](screenshots/assignment-02-screenshot-03.png)
...
![`nano App.js` open showing your full name and date filled in](screenshots/assignment-02-screenshot-04.png)
...
![Output of `ls` inside `my-react-app` showing the `build/` folder generated](screenshots/assignment-02-screenshot-05.png)
...
![Output of `ls /var/www/html/` showing the deployed build contents](screenshots/assignment-02-screenshot-06.png)
...
![Output of `systemctl is-active nginx` showing `active`](screenshots/assignment-02-screenshot-07.png)

---

#### Screenshot 8 — Output of `cat /etc/nginx/sites-available/default` showing the Nginx config

![Output of `cat /etc/nginx/sites-available/default` showing the Nginx config](screenshots/assignment-02-screenshot-08.png)
...
![Output of `curl ifconfig.me` showing the server's public IP address](screenshots/assignment-02-screenshot-09.png)

---

#### Screenshot 10 — Browser showing the deployed React app at `http://<public-ip>` with your name and date visible

![Browser showing the deployed React app at `http://<public-ip>` with your name and date visible](screenshots/assignment-02-screenshot-10.png)
...
`https://www.linkedin.com/posts/caryee_devops-aws-linux-activity-7483169854351630336-6JAT?utm_source=share&utm_medium=member_desktop&rcm=ACoAACP6ElcBF7-kOglrea_3V5oUhVp4NSh-Trc`
