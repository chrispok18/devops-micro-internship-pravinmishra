...
![Screenshot 1 — GitHub token creation page showing the selected scopes (`repo`, `read:user`) — token value must NOT be visible](screenshots/assignment-05-screenshot-01.png)
...
![Screenshot 2 — `.mcp.json` open in VS Code showing the full configuration](screenshots/assignment-05-screenshot-02.png)
...
![Screenshot 3 — `settings.local.json` open in VS Code showing the `env` section — ](screenshots/assignment-05-screenshot-03.png)
...
![Screenshot 4 — `/mcp` output showing `github: connected` ](screenshots/assignment-05-screenshot-04.png)
...
![Screenshot 5 — Claude's response showing the GitHub MCP tool call and the retrieved README.md content. ](screenshots/assignment-05-screenshot-05.png)
