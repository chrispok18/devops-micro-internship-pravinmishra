...
![Screenshot 1 — Terminal showing successful `terraform version` output](screenshots/assignment-01-screenshot-01.png)

---

#### Screenshot 2 — Terminal showing successful `az version` output

![Screenshot 2 — Terminal showing successful `az version` output](screenshots/assignment-01-screenshot-02.png)

---

#### Screenshot 3 — VS Code Extensions panel showing the HashiCorp Terraform extension installed and enabled

![Screenshot 3 — VS Code Extensions panel showing the HashiCorp Terraform extension installed and enabled](screenshots/assignment-01-screenshot-03.png)
...
![Screenshot 4 — VS Code showing the AzureRM provider configuration and resource group configuration in `main.tf`](screenshots/assignment-01-screenshot-04.png)
...
![Screenshot 5 — VS Code showing the Linux virtual machine configuration and public IP `output` block in `main.tf`. Ensure that the VM password is hidden or redacted](screenshots/assignment-01-screenshot-05.png)
...
![Screenshot 6 — Terminal showing the successful `terraform init` output](screenshots/assignment-01-screenshot-06.png)
...
![Screenshot 7 — Terraform plan summary showing the proposed resources](screenshots/assignment-01-screenshot-07.png)

---

#### Screenshot 8 — Terraform apply output showing successful completion

![Screenshot 8 — Terraform apply output showing successful completion](screenshots/assignment-01-screenshot-08.png)

---

#### Screenshot 9 — Terraform output showing the public IP address of the VM

![Screenshot 9 — Terraform output showing the public IP address of the VM](screenshots/assignment-01-screenshot-09.png)
...
![Screenshot 10 — Azure CLI output showing the deployed VM name and `VM running` status](screenshots/assignment-01-screenshot-10.png)
...
![Screenshot 11 — Terminal showing successful `terraform destroy` completion](screenshots/assignment-01-screenshot-11.png)
