...
![Screenshot 1 — Output of `git status` and `git branch` showing a clean status and the default branch checked out)`](screenshots/assignment-03-screenshot-01.png)
...
![Screenshot 2 — Output of `git checkout -b feature/contact-page` and `git branch` showing `* feature/contact-page`)`](screenshots/assignment-03-screenshot-02.png)
...
![Screenshot 3 — Output of `ls` showing `contact.html`)`](screenshots/assignment-03-screenshot-03.png)

---

#### Screenshot 4 — Output of `git commit`

![Screenshot 4 — Output of `git commit`)`](screenshots/assignment-03-screenshot-04.png)

---

#### Screenshot 5 — Output of `git log --oneline -3` showing the new commit

![Screenshot 5 — Output of `git log --oneline -3` showing the new commit](screenshots/assignment-03-screenshot-05.png)
...
![Screenshot 6 — Output of `git status` showing `index.html` as modified before staging](screenshots/assignment-03-screenshot-06.png)

---

#### Screenshot 7 — Output of `git commit`

![Screenshot 7 — Output of `git commit`](screenshots/assignment-03-screenshot-07.png)

---

#### Screenshot 8 — Browser showing the Contact Page link on the homepage while on `feature/contact-page`

![Screenshot 8 — Browser showing the Contact Page link on the homepage while on `feature/contact-page`](screenshots/assignment-03-screenshot-08.png)
...
![Screenshot 9 — Terminal showing the checkout and `ls` output, proving `contact.html` is absent](screenshots/assignment-03-screenshot-09.png)

---

#### Screenshot 10 — Browser showing the homepage on the default branch with no Contact Page link

![Screenshot 10 — Browser showing the homepage on the default branch with no Contact Page link](screenshots/assignment-03-screenshot-10.png)
...
![Screenshot 11 — Output of `git merge feature/contact-page`](screenshots/assignment-03-screenshot-11.png)

---

#### Screenshot 12 — Output of `ls` showing `contact.html` after the merge

![Screenshot 12 — Output of `ls` showing `contact.html` after the merge](screenshots/assignment-03-screenshot-12.png)

---

#### Screenshot 13 — Browser showing the Contact page opened from the homepage link on the default branch

![Screenshot 13 — Browser showing the Contact page opened from the homepage link on the default branch](screenshots/assignment-03-screenshot-13.png)
...
![Screenshot 14 — Full output of `git log --oneline --graph --decorate --all`](screenshots/assignment-03-screenshot-14.png)
...
![Screenshot 14 — Full output of `git log --oneline --graph --decorate --all`](screenshots/assignment-03-screenshot-15.png)
