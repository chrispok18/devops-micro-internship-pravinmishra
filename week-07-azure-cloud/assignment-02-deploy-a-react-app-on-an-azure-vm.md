...
![Screenshot 1 — Resource Group overview showing the name and region](screenshots/assignment-02-screenshot-01.png)
...
![Screenshot 2 — Azure VM overview page showing the VM name, Resource Group, and region](screenshots/assignment-02-screenshot-02.png)

---

#### Screenshot 3 — Network Security Group inbound rules showing ports 22 and 80 allowed

![Screenshot 3 — Network Security Group inbound rules showing ports 22 and 80 allowed](screenshots/assignment-02-screenshot-03.png)
...
![Screenshot 4 — Terminal showing a successful SSH login with the prompt visible](screenshots/assignment-02-screenshot-04.png)
...
![Screenshot 5 — Terminal output showing `node -v` and `npm -v`](screenshots/assignment-02-screenshot-05.png)
...
![Screenshot 6 — Terminal showing successful `npm run build` completion and `ls -la build` output](screenshots/assignment-02-screenshot-06.png)
...
![Screenshot 7 — Successful `sudo nginx -t` output](screenshots/assignment-02-screenshot-07.png)

---

#### Screenshot 8 — Nginx configuration snippet showing the build root and `try_files` directive

![ Screenshot 8 — Nginx configuration snippet showing the build root and `try_files` directive](screenshots/assignment-02-screenshot-08.png)
