...
![Screenshot 1 — Sprint 1 created with the Story inside it](screenshots/assignment-03-screenshot-01.png)

---

#### Screenshot 2 — Active Sprint board showing the Sprint Goal

![Screenshot 2 — Active Sprint board showing the Sprint Goal](screenshots/assignment-03-screenshot-02.png)
...
![Screenshot 3 — Jira board showing the Day 1 Sub-task in Done](screenshots/assignment-03-screenshot-03.png)

---

#### Screenshot 4 — Successful Git commit output

![Screenshot 4 — Successful Git commit output](screenshots/assignment-03-screenshot-04.png)

---

#### Screenshot 5 — EC2 browser view showing the complete footer text, with the URL visible

![Screenshot 5 — EC2 browser view showing the complete footer text, with the URL visible](screenshots/assignment-03-screenshot-05.png)

---

#### Screenshot 6 — Jira Story comment showing the Day 1 Daily Scrum update

![Screenshot 6 — Jira Story comment showing the Day 1 Daily Scrum update](screenshots/assignment-03-screenshot-06.png)
...
![Screenshot 7 — Code editor showing the footer and date logic or deployment-time template snippet](screenshots/assignment-03-screenshot-07.png)

---

#### Screenshot 8 — EC2 browser view showing the updated footer with the current date

![Screenshot 8 — EC2 browser view showing the updated footer with the current date](screenshots/assignment-03-screenshot-08.png)

---

#### Screenshot 9 — README snippet documenting the footer and date behavior

![Screenshot 9 — README snippet documenting the footer and date behavior](screenshots/assignment-03-screenshot-09.png)

---

#### Screenshot 10 — Jira Story comment showing the Day 2 Daily Scrum update

![Screenshot 10 — Jira Story comment showing the Day 2 Daily Scrum update](screenshots/assignment-03-screenshot-10.png)
...
![Screenshot 11 — Desktop EC2 view showing the polished footer](screenshots/assignment-03-screenshot-11.png)

---

#### Screenshot 12 — Mobile responsive view showing the footer remains readable

![Screenshot 12 — Mobile responsive view showing the footer remains readable](screenshots/assignment-03-screenshot-12.png)

---

#### Screenshot 13 — Jira Story comment showing the Day 3 Daily Scrum update

![Screenshot 13 — Jira Story comment showing the Day 3 Daily Scrum update](screenshots/assignment-03-screenshot-13.png)
...
![Screenshot 14 — EC2 browser view showing "Start your DevOps Journey here" and the clickable "Visit the DMI Website" link](screenshots/assignment-03-screenshot-14.png)
...
![Screenshot 15 — Burndown Chart for Sprint 1](screenshots/assignment-03-screenshot-15.png)

---

#### Screenshot 16 — Jira retrospective comment

![Screenshot 16 — Jira retrospective comment](screenshots/assignment-03-screenshot-16.png)

---

#### Screenshot 17 — Final EC2 browser view showing the complete footer requirement

![creenshot 17 — Final EC2 browser view showing the complete footer requirement](screenshots/assignment-03-screenshot-17.png)
...
`https://youtu.be/dWoK31j_uPI`

---

## Github URL

Paste your Github URL link here:

`https://github.com/chrispok18/Pravin-Mishra-Portfolio/tree/feature/footer-v1`
...
`https://www.linkedin.com/posts/caryee_dmibypravinmishra-devops-aws-ugcPost-7491610532005974016-Udkc/?utm_source=share&utm_medium=member_desktop&rcm=ACoAACP6ElcBF7-kOglrea_3V5oUhVp4NSh-Trc`

---

#### LinkedIn Screenshot 1 — Published LinkedIn post showing the post content and at least one required link or proof image

![LinkedIn Screenshot 1 — Published LinkedIn post showing the post content and at least one required link or proof image](screenshots/assignment-03-screenshot-18.png)
