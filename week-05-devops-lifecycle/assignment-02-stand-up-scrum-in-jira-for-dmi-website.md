...
![Screenshot 1 — Space confirmation or Space sidebar showing the Space name and key](screenshots/assignment-02-screenshot-01.png)
...
![Screenshot 2 — Backlog showing the Epic panel enabled and the Epic visible](screenshots/assignment-02-screenshot-02.png)
...
![Screenshot 3 — Backlog showing the Epic and all six Stories under it](screenshots/assignment-02-screenshot-03.png)

---

#### Screenshot 4 — One opened Story showing its Story point estimate, acceptance criteria, and label

![Screenshot 4 — One opened Story showing its Story point estimate, acceptance criteria, and label](screenshots/assignment-02-screenshot-04.png)
...
![Screenshot 5 — S2 showing all four Sub-tasks](screenshots/assignment-02-screenshot-05.png)

---

#### Screenshot 6 — S4 showing all four Sub-tasks

![Screenshot 6 — S4 showing all four Sub-tasks](screenshots/assignment-02-screenshot-06.png)
...
![Screenshot 7 — Backlog or Story details showing labels applied to at least two visible Stories](screenshots/assignment-02-screenshot-07a.png)

![Screenshot 7 — Backlog or Story details showing labels applied to at least two visible Stories](screenshots/assignment-02-screenshot-07b.png)
...
![Screenshot 8 — Sprint 1 before starting, showing the selected Stories and Story Points](screenshots/assignment-02-screenshot-08.png)

---

#### Screenshot 9 — Active Sprint board showing the started Sprint and Sprint Goal

![Screenshot 9 — Active Sprint board showing the started Sprint and Sprint Goal](screenshots/assignment-02-screenshot-09.png)
...
![Screenshot 10 — Filter for label = frontend showing the filtered results](screenshots/assignment-02-screenshot-10.png)

---

#### Screenshot 11 — Filter for label = devops showing the filtered results

![Screenshot 11 — Filter for label = devops showing the filtered results](screenshots/assignment-02-screenshot-11.png)
...
![Screenshot 12 — Burndown Chart page opened for Sprint 1](screenshots/assignment-02-screenshot-12.png)
