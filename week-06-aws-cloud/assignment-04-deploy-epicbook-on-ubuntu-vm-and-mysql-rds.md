...
![Screenshot 1 — VPC details showing CIDR 10.0.0.0/16](screenshots/assignment-04-screenshot-01.png)

---

#### Screenshot 2 — Subnets list showing both subnets and their CIDRs

![Screenshot 2 — Subnets list showing both subnets and their CIDRs](screenshots/assignment-04-screenshot-02.png)

---

#### Screenshot 3 — Route table showing 0.0.0.0/0 → IGW and association with the public subnet

![Screenshot 3 — Route table showing 0.0.0.0/0 → IGW and association with the public subnet](screenshots/assignment-04-screenshot-03.png)
...
![Screenshot 4 — EC2 security-group inbound rules showing ports and sources](screenshots/assignment-04-screenshot-04.png)

---

#### Screenshot 5 — RDS security-group inbound rule showing MySQL 3306 allowed from the EC2 security group

![Screenshot 5 — RDS security-group inbound rule showing MySQL 3306 allowed from the EC2 security group](screenshots/assignment-04-screenshot-05.png)
...
![Screenshot 6 — EC2 instance summary showing the public IPv4 address, subnet, and security group](screenshots/assignment-04-screenshot-06.png)

---

#### Screenshot 7 — Terminal showing a successful SSH login with the `ubuntu@...` prompt

![Screenshot 7 — Terminal showing a successful SSH login with the `ubuntu@...` prompt](screenshots/assignment-04-screenshot-07.png)
...
![Screenshot 8 — Output of `node -v` and `npm -v`](screenshots/assignment-04-screenshot-08.png)

---

#### Screenshot 9 — Output of `systemctl status nginx`

![Screenshot 9 — Output of `systemctl status nginx`](screenshots/assignment-04-screenshot-09.png)

---

#### Screenshot 10 — Output of `mysql --version`

![Screenshot 10 — Output of `mysql --version`](screenshots/assignment-04-screenshot-10.png)
...
![Screenshot 11 — RDS instance summary showing Publicly accessible: No](screenshots/assignment-04-screenshot-11.png)

---

#### Screenshot 12 — Connectivity & security section showing the VPC and attached security group

![Screenshot 12 — Connectivity & security section showing the VPC and attached security group](screenshots/assignment-04-screenshot-12.png)
...
![Screenshot 13 — Terminal showing successful `SHOW TABLES;` output with tables listed](screenshots/assignment-04-screenshot-13.png)
...
![Screenshot 14 — Terminal showing the repository cloned and the `ls` output](screenshots/assignment-04-screenshot-14.png)

---

#### Screenshot 15 — Terminal showing the backend running, or `ss -tulpn` showing the port open

![Screenshot 15 — Terminal showing the backend running, or `ss -tulpn` showing the port open](screenshots/assignment-04-screenshot-15.png)

---

#### Screenshot 16 — `curl` output proving the backend responds; a 200, 301, or 404 response is acceptable if the service responds

![Screenshot 16 — `curl` output proving the backend responds; a 200, 301, or 404 response is acceptable if the service responds](screenshots/assignment-04-screenshot-16.png)
...
![`nginx -t` success output](screenshots/assignment-04-screenshot-17.png)

---

#### Screenshot 18 — Nginx configuration snippet showing the `/api/` reverse proxy

![Screenshot 18 — Nginx configuration snippet showing the `/api/` reverse proxy](screenshots/assignment-04-screenshot-18.png)
...
![Screenshot 19 — Browser showing the EpicBook application loaded with the public IP visible](screenshots/assignment-04-screenshot-19.png)

---

#### Screenshot 20 — Terminal showing a successful API call through the public endpoint, such as `curl http://<EC2_PUBLIC_IP>/api/...`

![Screenshot 20 — Terminal showing a successful API call through the public endpoint, such as `curl http://<EC2_PUBLIC_IP>/api/...`](screenshots/assignment-04-screenshot-20.png)

---

#### Screenshot 21 — Terminal showing the successful database connectivity test using `SELECT 1;` or similar

![Screenshot 21 — Terminal showing the successful database connectivity test using `SELECT 1;` or similar](screenshots/assignment-04-screenshot-21.png)
