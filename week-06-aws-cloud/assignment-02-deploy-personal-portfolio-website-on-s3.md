...
![Screenshot 1 — File Explorer or terminal showing the template folder contents with `index.html` visible](screenshots/assignment-02-screenshot-01.png)
...
![Screenshot 2 — S3 bucket created screen showing the bucket name and region](screenshots/assignment-02-screenshot-02.png)
...
![Screenshot 3 — S3 bucket Objects view showing `index.html` at the top or root level](screenshots/assignment-02-screenshot-03.png)
...
![Screenshot 4 — Static website hosting enabled screen showing the Website endpoint](screenshots/assignment-02-screenshot-04.png)
...
![Screenshot 5 — Bucket policy page showing the policy saved successfully, with the bucket name visible](screenshots/assignment-02-screenshot-05.png)
...
![Screenshot 6 — Browser showing the live website with the S3 website endpoint visible in the address bar](screenshots/assignment-02-screenshot-06.png)
...
![Screenshot 7 (optional) — Before and after views, or a browser view showing the updated text](screenshots/assignment-02-screenshot-07.png)
